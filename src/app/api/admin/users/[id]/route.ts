...
/** GET /api/admin/users/:id – ดึงผู้ใช้รายคน (ใช้ตอนเปิด modal/ดูรายละเอียด) */
export async function GET(
  ...
  try {
    ...
    if (e?.status) return e; // จาก throw NextResponse
...
export async function DELETE(
  ...
  try {
    ...
    // ป้องกันลบตัวเอง (เอาออกได้ถ้าอยากให้ลบได้)
